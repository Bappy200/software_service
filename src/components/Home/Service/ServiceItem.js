...
function ServiceItem({description,title,imageUrl,price,_id,state,fromBooking}) {
        ...
        <div className='col-md-4'>
            ...
            <div className="card__side card__side--back card__side--back-1">
              <div className="card__cta">
                ...
                {!fromBooking && <button className="brnad-button" onClick={()=> handlerService(_id)}>Select</button>}
              </div>
            </div>
          </div>
        </div>
