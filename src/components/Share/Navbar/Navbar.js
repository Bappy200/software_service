...
function Navbar() {
    ...
    return (
            ...
            <nav className="navbar navbar-expand-lg navbar-light" style={{background:'rgba(56, 54, 54, 0.138)',boxShadow:' rgb(255 255 255 / 56%) 2px 1px 7px 0px',padding:'5px 100px'}}>
